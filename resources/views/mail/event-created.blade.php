                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p class="paragraph">You have created a new event. Details are as follows:</p>

                                        <div>
                                            <table style="border: 1px solid #cccccc; border-collapse: collapse; cellspacing='0'; font-size: 0.65em;" width="100%" class="content-table">
                                                <tbody>
                                                    <tr>
                                                        <th>Name</th>
                                                        <td>{{ $event->name }}</td>
